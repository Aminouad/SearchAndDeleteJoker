        ...
        public IList<TextLocation> GetLocations()
        {
            ...
            foreach (var chunk in filteredTextChunks)
            {
                ...
                if (lastChunk == null)
                {
                    ...
                    var bottomLeft = chunk.Location.StartLocation[0];
                    var topRight = chunk.Location.EndLocation[0];

                    //Create a rectangle from it
                    var rect = new iTextSharp.text.Rectangle(bottomLeft, bottomLeft, topRight, topRight);
